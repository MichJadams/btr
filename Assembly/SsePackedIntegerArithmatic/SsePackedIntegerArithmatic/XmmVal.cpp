...
{
	sprintf_s(s, len, "%4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d %4d", i8[0], i8[1], i8[2], i8[3], i8[4], i8[5], i8[6], i8[7],
...
{
	sprintf_s(s, len, "%4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u %4u", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7],
...
{
	sprintf_s(s, len, "%02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7],
		u8[8], u8[9], u8[10], u8[11], u8[12], u8[13], u8[14], u8[15]);
